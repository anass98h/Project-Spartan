...
GrenadeType GetGrenadeType( C_BaseCombatWeapon *wpn ) {
    ...
    if ( !strcmp( wpn->GetCSWpnData( )->szClassName, XORSTR( "weapon_flashbang" ) ) ||
         !strcmp( wpn->GetCSWpnData( )->szClassName, XORSTR( "weapon_decoy" ) ) )
...
static ImColor GetColor( GrenadeType type ) {
    switch ( type ) {
        case GrenadeType::HEGRENADE: return Settings::GrenadeHelper::infoHE.Color( );
        case GrenadeType::SMOKE: return Settings::GrenadeHelper::infoSmoke.Color( );
        case GrenadeType::FLASH: return Settings::GrenadeHelper::infoFlash.Color( );
        case GrenadeType::MOLOTOV: return Settings::GrenadeHelper::infoMolotov.Color( );
