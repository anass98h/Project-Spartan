...
void lbyindicator::PaintImGui( ) {
    ...
    if ( AntiAim::isAntiAiming ) {
        ...
        Draw::ImLine( ImVec2( radarCenterX, radarCenterY ),
                      ImVec2( 55 * cos( DEG2RAD( 90 - fakeYawDiff ) ) + radarCenterX,
                              radarCenterY - ( 55 * sin( DEG2RAD( 90 - fakeYawDiff ) ) ) ), ImColor( 10, 10, 200 ) );
    }
    ...
    Draw::ImCircleFilled( ImVec2( radarCenterX + 55, radarCenterY + 55 ), ImColor( col.r, col.g, col.b ), 5,
                          16 );  // LBY indicator Light
    Draw::ImLine( ImVec2( radarCenterX, radarCenterY ), ImVec2( radarCenterX, radarNorthEndY ),
                  ImColor( 0, 0, 0 ) ); // Const Line facing North
    Draw::ImLine( ImVec2( radarCenterX, radarCenterY ), ImVec2( radar125EndX, radar125EndY ),
                  ImColor( 0, 0, 0 ) ); // Const Line Left-of N-Line
    Draw::ImLine( ImVec2( radarCenterX, radarCenterY ), ImVec2( radar55EndX, radar55EndY ),
                  ImColor( 0, 0, 0 ) ); // Const Line Right-of N-Line
    Draw::ImLine( ImVec2( radarCenterX, radarCenterY ), ImVec2( 55 * cos( DEG2RAD( 90 - realYawDiff ) ) + radarCenterX,
                                                                radarCenterY -
                                                                ( 55 * sin( DEG2RAD( 90 - realYawDiff ) ) ) ),
                  ImColor( col.r, col.g, col.b ) ); // Real Yaw Line
