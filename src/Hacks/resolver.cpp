    ...
    switch ( Settings::Resolver::Hugtype ) {
        ...
        case ResolverHugtype::APOSTROPHE: {
            if ( LowerBodyYawChanged( Circlebian ) ) {
                ...
                switch ( num ) {
                    case 0:Circlebian->GetEyeAngles( )->y -= 0.0f;
                        break;
                    case 1:Circlebian->GetEyeAngles( )->y += 90.0f;
                        break;
                    case 2:Circlebian->GetEyeAngles( )->y -= 90.0f;
                        break;
                    case 3:Circlebian->GetEyeAngles( )->y -= 180.0f;
                        break;
                }
            }
        ...
        case ResolverHugtype::BRUTE1: {
            ...
            switch ( num2 ) {
                case 0:Circlebian->GetEyeAngles( )->y -= 0.0f;
                    break;
                case 1:Circlebian->GetEyeAngles( )->y = 35.0f;
                    break;
                case 2:Circlebian->GetEyeAngles( )->y = -70.0f;
                    break;
                case 3:Circlebian->GetEyeAngles( )->y = 55.0f;
                    break;
                case 4:Circlebian->GetEyeAngles( )->y = -180.0f;
                    break;
                case 5:Circlebian->GetEyeAngles( )->y = -30.0f;
                    break;
            }
            break;
        }
