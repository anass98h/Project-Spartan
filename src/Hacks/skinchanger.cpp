        ...
        for ( size_t i = 0; localplayer->GetWeapons( )[i] != ( int )0xFFFFFFFF; i++ ) {
            ...
            if ( currentModel.itemDefinitionIndex != ItemDefinitionIndex::INVALID &&
                ...
                *weapon->GetModelIndex( ) = modelInfo->GetModelIndex(
                ...
                if ( ItemDefinitionIndexMap.find( *weapon->GetItemDefinitionIndex( ) ) !=
                     ItemDefinitionIndexMap.end( ) ) {
...
void SkinChanger::FireEventClientSide( IGameEvent *event ) {
    ...
    event->SetString( "weapon", killIcons.find( weapon ) != killIcons.end( ) ? killIcons.at( weapon ).c_str( )
                                                                             : weapon.c_str( ) );
}
    ...
    if ( pViewModel ) {
        ...
        if ( pOwner && pOwner->GetIndex( ) == engine->GetLocalPlayer( ) ) {
            ...
            if ( szModel == "models/weapons/v_knife_butterfly.mdl" ) {
                ...
                switch ( m_nSequence ) {
                    case SEQUENCE_DEFAULT_IDLE2:m_nSequence = SEQUENCE_FALCHION_IDLE1;
                        break;
                ...
                switch ( m_nSequence ) {
                    case SEQUENCE_DEFAULT_IDLE2:m_nSequence = SEQUENCE_DAGGERS_IDLE1;
                        break;
                    ...
                    case SEQUENCE_DEFAULT_LOOKAT01:m_nSequence += 3;
                        break;
                    case SEQUENCE_DEFAULT_DRAW:
                    case SEQUENCE_DEFAULT_IDLE1:break;
                    default:m_nSequence += 2;
                }
                ...
                switch ( m_nSequence ) {
                    case SEQUENCE_DEFAULT_DRAW:
                    case SEQUENCE_DEFAULT_IDLE1:break;
                    case SEQUENCE_DEFAULT_IDLE2:m_nSequence = SEQUENCE_BOWIE_IDLE1;
                        break;
                    default:m_nSequence--;
                }
            }
