...
static void DrawPlayer( void *thisptr, void *context, void *state, const ModelRenderInfo_t &pInfo,
    ...
    switch ( Settings::ESP::Chams::type ) {
        ...
        case ChamsType::CHAMS_XQZ:visible_material = materialChams;
            hidden_material = materialChamsIgnorez;
            break;
        case ChamsType::CHAMS_FLAT:
        case ChamsType::CHAMS_FLAT_XQZ:visible_material = materialChamsFlat;
            hidden_material = materialChamsFlatIgnorez;
            break;
        case ChamsType::CHAMS_GLASS:visible_material = materialChamsGlass;
            hidden_material = materialChamsGlass;
            break;
        case ChamsType::CHAMS_CRYSTAL:visible_material = materialChamsCrystal;
            hidden_material = materialChamsCrystal;
            break;
        case ChamsType::CHAMS_CRYSTALBLUE:visible_material = materialChamsBlueCrystal;
            hidden_material = materialChamsBlueCrystal;
            break;
        case ChamsType::CHAMS_GOLD:visible_material = materialChamsGold;
            hidden_material = materialChamsGold;
            break;
        case ChamsType::CHAMS_VELVET:visible_material = materialChamsVelvet;
            hidden_material = materialChamsVelvet;
            break;
        case ChamsType::CHAMS_TREE:visible_material = materialChamsTree;
            hidden_material = materialChamsTree;
            break;
        case ChamsType::CHAMS_SPEECHINFO:visible_material = materialChamsSpeechInfo;
            hidden_material = materialChamsSpeechInfo;
            break;
        case ChamsType::CHAMS_FISHNET:visible_material = materialChamsFishNet;
            hidden_material = materialChamsFishNet;
            break;
        case ChamsType::CHAMS_LETTERS:visible_material = materialChamsLetters;
            hidden_material = materialChamsLetters;
            break;
        case ChamsType::CHAMS_GLOSS:visible_material = materialChamsGloss;
...
static void DrawArms( const ModelRenderInfo_t &pInfo ) {
    ...
    switch ( Settings::ESP::Chams::Arms::type ) {
        default:break;
        case ArmsType::DEFAULT:mat->AlphaModulate( 1.0f );
        ...
        case ArmsType::TREE:
            ...
            mat->ColorModulate( Settings::ESP::Chams::Arms::color.Color( ) );
            break;
        case ArmsType::SPEECHINFO:mat = material->FindMaterial( "models/extras/speech_info", TEXTURE_GROUP_OTHER );
            mat->AlphaModulate( 1.0f );
            mat->ColorModulate( Settings::ESP::Chams::Arms::color.Color( ) );
            break;
        case ArmsType::FISHNET:mat = material->FindMaterial( "models/props_shacks/fishing_net01", TEXTURE_GROUP_OTHER );
            mat->AlphaModulate( 1.0f );
            mat->ColorModulate( Settings::ESP::Chams::Arms::color.Color( ) );
            break;
