...
void Interfaces::FindInterfaces( ) {
    ...
    debugOverlay = GetInterface<IVDebugOverlay>( XORSTR( "./bin/linux64/engine_client.so" ),
                                                 XORSTR( "VDebugOverlay" ) );
    ...
    inputInternal = GetInterface<IInputInternal>( XORSTR( "./bin/linux64/vgui2_client.so" ),
                                                  XORSTR( "VGUI_InputInternal" ) );
    ...
    prediction = GetInterface<IPrediction>( XORSTR( "./csgo/bin/linux64/client_client.so" ),
                                            XORSTR( "VClientPrediction" ) );
    gameMovement = GetInterface<IGameMovement>( XORSTR( "./csgo/bin/linux64/client_client.so" ),
                                                XORSTR( "GameMovement" ) );
    ...
    commandline = GetSymbolAddress<CommandLineFn>( XORSTR( "./bin/linux64/libtier0_client.so" ),
                                                   XORSTR( "CommandLine" ) )( );
}
/*
