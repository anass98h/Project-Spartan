    ...
    namespace Items {
        ...
        std::string GetItemDisplayName( ItemDefinitionIndex index ) {
            if ( ItemDefinitionIndexMap.find( index ) != ItemDefinitionIndexMap.end( ) ) {
                if ( ItemDefinitionIndexMap.find( index ) != ItemDefinitionIndexMap.end( ) &&
                    ...
                    return Util::WstringToString(
                            localize->FindSafe( ItemDefinitionIndexMap.at( index ).displayName ) );
        ...
        bool IsKnife( ItemDefinitionIndex index ) {
            switch ( index ) {
                ...
                case ItemDefinitionIndex::WEAPON_KNIFE_PUSH: return true;
        ...
        bool IsUtility( ItemDefinitionIndex index ) {
            switch ( index ) {
                ...
                case ItemDefinitionIndex::WEAPON_DECOY: return true;
                default: return false;
            }
        }
        ...
        bool IsGlove( ItemDefinitionIndex index ) {
            switch ( index ) {
                ...
                case ItemDefinitionIndex::GLOVE_LEATHER_WRAP: return true;
                default: return false;
            }
        }
        ...
        bool IsCTWeapon( ItemDefinitionIndex index ) {
            switch ( index ) {
                ...
                case ItemDefinitionIndex::WEAPON_MP9: return true;
                default: return false;
            }
        }
        ...
        bool IsTWeapon( ItemDefinitionIndex index ) {
            switch ( index ) {
                ...
                case ItemDefinitionIndex::WEAPON_MAC10: return true;
                default: return false;
            }
        }
    }
