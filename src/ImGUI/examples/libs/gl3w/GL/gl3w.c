...
static void load_procs( void ) {
    ...
    gl3wGetTransformFeedbackVarying = ( PFNGLGETTRANSFORMFEEDBACKVARYINGPROC )get_proc(
    ...
    gl3wDrawRangeElementsBaseVertex = ( PFNGLDRAWRANGEELEMENTSBASEVERTEXPROC )get_proc(
            "glDrawRangeElementsBaseVertex" );
    gl3wDrawElementsInstancedBaseVertex = ( PFNGLDRAWELEMENTSINSTANCEDBASEVERTEXPROC )get_proc(
            "glDrawElementsInstancedBaseVertex" );
    gl3wMultiDrawElementsBaseVertex = ( PFNGLMULTIDRAWELEMENTSBASEVERTEXPROC )get_proc(
    ...
    gl3wBindFragDataLocationIndexed = ( PFNGLBINDFRAGDATALOCATIONINDEXEDPROC )get_proc(
    ...
    gl3wDrawTransformFeedbackStream = ( PFNGLDRAWTRANSFORMFEEDBACKSTREAMPROC )get_proc(
