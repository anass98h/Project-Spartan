...
HRESULT CreateDeviceD3D( HWND hWnd ) {
    ...
    if ( D3D10CreateDeviceAndSwapChain( NULL, D3D10_DRIVER_TYPE_HARDWARE, NULL, createDeviceFlags, D3D10_SDK_VERSION,
                                        &sd, &g_pSwapChain, &g_pd3dDevice ) != S_OK )
        return E_FAIL;
...
int main( int, char ** ) {
    ...
    RegisterClassEx( &wc );
    HWND hwnd = CreateWindow( _T( "ImGui Example" ), _T( "ImGui DirectX10 Example" ), WS_OVERLAPPEDWINDOW, 100, 100,
