...
static void frame_begin( ) {
    ...
    {
        err = vkAcquireNextImageKHR( g_Device, g_Swapchain, UINT64_MAX, g_Semaphore[g_FrameIndex], VK_NULL_HANDLE,
                                     &g_BackBufferIndex );
        check_vk_result( err );
    }
    {
...
static void frame_end( ) {
    ...
    vkCmdEndRenderPass( g_CommandBuffer[g_FrameIndex] );
    {
        ...
        vkCmdPipelineBarrier( g_CommandBuffer[g_FrameIndex], VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT,
