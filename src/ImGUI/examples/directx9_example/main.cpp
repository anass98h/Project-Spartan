...
int main( int, char ** ) {
    ...
    RegisterClassEx( &wc );
    HWND hwnd = CreateWindow( _T( "ImGui Example" ), _T( "ImGui DirectX9 Example" ), WS_OVERLAPPEDWINDOW, 100, 100,
    ...
    while ( msg.message != WM_QUIT ) {
        ...
        D3DCOLOR clear_col_dx = D3DCOLOR_RGBA( ( int )( clear_col.x * 255.0f ), ( int )( clear_col.y * 255.0f ),
