...
void ImDrawList::UpdateClipRect() {
    ...
    if ( !curr_cmd ||
         ( curr_cmd->ElemCount != 0 && memcmp( &curr_cmd->ClipRect, &curr_clip_rect, sizeof( ImVec4 ) ) != 0 ) ||
...
void ImDrawList::PathRect( const ImVec2& a, const ImVec2& b, float rounding, int rounding_corners ) {
    ...
    float r = rounding;
    r = ImMin( r, fabsf( b.x - a.x ) * ( ( ( rounding_corners & corners_top ) == corners_top ) ||
                                         ( ( rounding_corners & corners_bottom ) == corners_bottom ) ? 0.5f : 1.0f ) -
                  1.0f );
    r = ImMin( r, fabsf( b.y - a.y ) * ( ( ( rounding_corners & corners_left ) == corners_left ) ||
                                         ( ( rounding_corners & corners_right ) == corners_right ) ? 0.5f : 1.0f ) -
                  1.0f );
...
void
ImDrawList::AddBezierCurve( const ImVec2& pos0, const ImVec2& cp0, const ImVec2& cp1, const ImVec2& pos1, ImU32 col,
    ...
    for ( int input_i = 0; input_i < atlas->ConfigData.Size; input_i++ ) {
        ...
        for ( int i = 0; i < tmp.RangesCount; i++ ) {
            ...
            for ( int char_idx = 0; char_idx < range.num_chars; char_idx += 1 ) {
                ...
                dst_font->MetricsTotalSurface += ( int ) ( ( glyph.U1 - glyph.U0 ) * atlas->TexWidth + 1.99f ) *
...
void ImFontAtlasBuildRegisterDefaultCustomRects( ImFontAtlas* atlas ) {
    ...
    if ( atlas->CustomRects.empty() )
        atlas->CustomRectRegister( FONT_ATLAS_DEFAULT_TEX_DATA_ID, FONT_ATLAS_DEFAULT_TEX_DATA_W_HALF * 2 + 1,
