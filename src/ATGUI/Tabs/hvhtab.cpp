...
{
	const char* yTypes[] = {
			"Legit Trolling", "Legit Trolling 2", "No AA", "SLOW SPIN", "Tank", "SMTH FAKE", "FAST SPIN", "Random Spin", "LBYSPIN", "RANDOM BACKJITTER", "TURBO JITTER", "TURBO SPIN", "CASUAL JITTER", "LBY JITTER", "JITTER", "BACKJITTER", "SIDEWAYS RIGHT", "SIDEWAYS LEFT", "FAKE SIDEWAYS", "BACKWARDS", "FORWARDS", "STATIC", "STATIC JITTER", "STATIC SMALL JITTER", "LUA", "LUA2", "CASUALAA",// safe
