...
void HvH::RenderTab()
{
	const char* yTypes[] = {
			...
			"Legit Trolling", "Legit Trolling 2", "No AA", "Spinbot", "Tank", "Tank 2", "Tank 3", "LBYSPIN", "RANDOM BACKJITTER", "CASUAL JITTER", "LBY JITTER", "JITTER", "BACKJITTER", "SIDEWAYS RIGHT", "SIDEWAYS LEFT", "FAKE SIDEWAYS", "BACKWARDS", "FORWARDS", "STATIC", "STATIC JITTER", "STATIC SMALL JITTER", "LUA", "LUA2", "CASUALAA",// safe
