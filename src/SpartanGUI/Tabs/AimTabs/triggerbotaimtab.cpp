    ...
    ImGui::Columns( 2, NULL, true );
    {
        ImGui::BeginChild( XORSTR( "TRIG1" ), ImVec2( 0, 0 ), true );
        {
            ...
            ImGui::NextColumn();
            {
                ...
                ImGui::SliderInt( XORSTR( "##TRIGGERRANDOMLOW" ), &Settings::Triggerbot::RandomDelay::lowBound, 5,
                                  220 );
                ...
                ImGui::SliderInt( XORSTR( "##TRIGGERRANDOMHIGH" ), &Settings::Triggerbot::RandomDelay::highBound,
                                  ( Settings::Triggerbot::RandomDelay::lowBound + 1 ), 225 );
            }
            ImGui::Columns( 1 );
            ImGui::Separator();
