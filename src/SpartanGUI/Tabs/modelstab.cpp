...
void Models::RenderTab() {
    ...
    ImGui::InputText( XORSTR( "##filterOriginalModelCT" ), filterOriginalModelsCT,
                      IM_ARRAYSIZE( filterOriginalModelsCT ) );
    ImGui::PopItemWidth();
    ImGui::NextColumn();
    ...
    ImGui::PushItemWidth( -1 );
    ImGui::InputText( XORSTR( "##filterOriginalModelT" ), filterOriginalModelsT,
                      IM_ARRAYSIZE( filterOriginalModelsT ) );
    ImGui::PopItemWidth();
    ImGui::NextColumn();
