        ...
        ImGui::BeginChild(XORSTR("##ANTIAIM1"), ImVec2(0, 0), true);
        {
            ...
            ImGui::BeginChild(XORSTR("##ANTIAIM3"), ImVec2(0, 0), true);
            {
                    ...
                    {
                        {
                            ...
                            ImGui::SliderFloat(XORSTR("##YFAKECUSTOM"), &Settings::AntiAim::Airborne::Yaw::typeFakeAdd,
                                               Settings::AntiAim::Airborne::untrustedAngles ? -1000 : -180,
                                               Settings::AntiAim::Airborne::untrustedAngles ? 1000 : 180,
                                               XORSTR(Settings::AntiAim::Airborne::Yaw::typeFakeAdd > 0 ? "+%.1f" : "%.1f"));
                            ImGui::PopItemWidth();
                        }
                        ImGui::Separator();
                        {
                            ...
                            ImGui::SliderFloat(XORSTR("##YCUSTOM"), &Settings::AntiAim::Airborne::Yaw::typeAdd,
                                               Settings::AntiAim::Airborne::untrustedAngles ? -1000 : -180,
                                               Settings::AntiAim::Airborne::untrustedAngles ? 1000 : 180,
                                               XORSTR(Settings::AntiAim::Airborne::Yaw::typeAdd > 0 ? "+%.1f" : "%.1f"));
                            ImGui::PopItemWidth();
                        }
                    }
                    ImGui::Columns(1);
                ...
                ImGui::Checkbox(XORSTR("Pitch"), &Settings::AntiAim::Airborne::Pitch::enabled);
                {
                    ...
                    ImGui::NextColumn();
                    {
                        ...
                        ImGui::SliderFloat(XORSTR("##XCUSTOM"), &Settings::AntiAim::Airborne::Pitch::custom,
                                           Settings::AntiAim::Airborne::untrustedAngles ? -1000 : -180,
                                           Settings::AntiAim::Airborne::untrustedAngles ? 1000 : 180,
                                           XORSTR(Settings::AntiAim::Airborne::Pitch::custom > 0 ? "+%.1f" : "%.1f"));
                        ImGui::PopItemWidth();
                    }
                    ImGui::Columns(1);
                }
                ...
                ImGui::Checkbox(XORSTR("Head Edge"), &Settings::AntiAim::Airborne::HeadEdge::enabled);
                {
                    ...
                    {
                        ImGui::PushItemWidth(-1);
                        ImGui::SliderFloat(XORSTR("##EDGEDISTANCE"), &Settings::AntiAim::Airborne::HeadEdge::distance, 20, 30,
                                           "%0.f");
                        ImGui::PopItemWidth();
                    }
                    ImGui::Columns(1);
