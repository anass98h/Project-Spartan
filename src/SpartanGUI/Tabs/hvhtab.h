...
namespace HvH {
    ...
    static const char* yTypes[] = {
            "No AA", "Forwards", "Backwards", "Spin", "Fake Sideways", "Backjitter", "FJitter", "ZeusJitter", "LBY Jitter", "LBY Spin",
    ...
    static const char* lbyTypes[] = { "Breaker 1", "Breaker 2", "Breaker 3", "Avoz", "Myrrib", "myyrib2" "None" };
