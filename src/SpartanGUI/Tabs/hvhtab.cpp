...
void HvH::RenderTab() {
    ...
    const char *yTypes[] = {
            "No AA", "Backwards", "Forwards", "FakeSideWays", "Spin", "Backjitter", "FJitter", "TJitter", "Tank 1",
            "Tank 2", "Tank 3", "Richi's EAP", "Myrrib's EAP",
            "LBY Breaker", "FakeLBY", "LBY Spin", "LBYJitter", "LBY", "LBY on Ground", "Legittrolling",
            "Legittrolling2",
            "Custom", "Custom2" // safe
    };
