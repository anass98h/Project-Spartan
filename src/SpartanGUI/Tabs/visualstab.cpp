...
void Visuals::RenderTab( ) {
    ...
    const char *ChamsTypes[] = {
            "Normal", "Normal - XQZ", "Flat", "Flat - XQZ", "Glass", "Crystal", "BlueCrystal", "Gold", "Velvet", "Tree",
            "SpeechInfo", "FishNet", "Letters", "Gloss"
    };
    const char *ArmsTypes[] = {
            "Default", "Glass", "Crystal", "BlueCrystal", "Gold", "Velvet", "Tree", "SpeechInfo", "FishNet", "Letters",
            "Gloss", "Wireframe", "None"
    };
