...
void Main::RenderWindow( ) {
    ...
    if ( Settings::UI::combinedMenu ) {
        ...
        if ( ImGui::Begin( ( "project-spartan" ), &Main::showWindow,
                           ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_ShowBorders | ImGuiWindowFlags_NoScrollbar |
            ...
            ImGui::BeginChild( "Main1", ImVec2( 150, 0 ), true,
                               ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoResize );
            {
                for ( int i = 0; i < IM_ARRAYSIZE( tabs ); i++ ) {
                    ...
                    if ( ImGui::Button( tabs[i], ImVec2( ImGui::GetWindowSize( ).x - 9,
                                                         ImGui::GetWindowSize( ).y / IM_ARRAYSIZE( tabs ) - 6 ) ) )
                        page = i;
            ...
            ImGui::SameLine( );
            ImGui::BeginChild( "Main2", ImVec2( 0, 0 ), true,
                               ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoResize );
            {

                switch ( page ) {
                    case 0:Aimbot::RenderTab( );
                        break;
                    case 1:Triggerbot::RenderTab( );
                        break;
                    case 2:Visuals::RenderTab( );
                        break;
                    case 3:
